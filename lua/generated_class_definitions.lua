classes = {
    ...
    calendar = {
        ...
        functions = {
            ...
            { name = "print_approx_duration", static = true, rval = "std::string", args = { "int" } },
            { name = "print_approx_duration", static = true, rval = "std::string", args = { "int", "bool" } },
            { name = "print_clipped_duration", static = true, rval = "std::string", args = { "int" } },

...
tripoint editmap::edit()
{
    ...
    w_info = catacurses::window( infoHeight, width, TERMY - infoHeight, offsetX );
    w_help = catacurses::window( 3, width - 2, TERMY - 3, offsetX + 1 );
...
int editmap::edit_ter()
{
    ...
    catacurses::window w_pickter( pwh, width, VIEW_OFFSET_Y, offsetX );
...
int editmap::edit_trp()
{
    ...
    catacurses::window w_picktrap( pwh, width, VIEW_OFFSET_Y, offsetX );
...
int editmap::mapgen_preview( real_coords &tc, uimenu &gmenu )
{
    ...
    catacurses::window w_preview( 24, 24, pofs.y, pofs.x );

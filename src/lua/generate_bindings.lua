...
function generate_destructor(class_name)
    local cpp_output = ""
    cpp_output = cpp_output .. "template<>" .. br
    cpp_output = cpp_output .. "void LuaValue<" .. class_name .. ">::call_delete( " .. class_name .. " *const ptr ) {" .. br
...
local cpp_header = "// This file was automatically generated by lua/generate_bindings.lua"..br
cpp_header = cpp_header .. "extern \"C\" {"..br
cpp_header = cpp_header .. "#include <lua.h>"..br
cpp_header = cpp_header .. "}"..br
cpp_header = cpp_header .. "#include \"type.h\""..br
cpp_header = cpp_header .. "#include \"enum.h\""..br
cpp_header = cpp_header .. "#include \"value_or_reference.h\""..br
...
function generate_functions_for_class(class_name, class)
    ...
    while class do
        ...
        if class.by_value or class.by_value_and_reference then
            cpp_output = cpp_output .. generate_destructor(class_name)
        end
        if class.has_equal then

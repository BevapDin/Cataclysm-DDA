...
class LuaValue
{
    private:
        ...
        static void get_metatable( lua_State *const L ) {
            ...
            lua_pushcfunction( L, &catch_exception_for_lua_wrapper<&gc> );
            // -1 would be the function pointer, -2 is the metatable, the function pointer is popped
            lua_setfield( L, -2, "__gc" );
            lua_pushcfunction( L, &catch_exception_for_lua_wrapper<&index> );
            lua_setfield( L, -2, "__index" );
            lua_pushcfunction( L, &catch_exception_for_lua_wrapper<&newindex> );

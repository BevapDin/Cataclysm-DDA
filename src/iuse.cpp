...
int iuse::fishing_rod( player *p, item *it, bool, const tripoint & )
{
    ...
    p->assign_activity( activity_id( "ACT_FISH" ), 30_minutes, 0, p->get_item_position( it ),
                        it->tname() );
...
int iuse::portable_game( player *p, item *it, bool, const tripoint & )
{
    ...
    if( p->has_trait( trait_ILLITERATE ) ) {
        ...
        p->assign_activity( activity_id( "ACT_GAME" ), 15_minutes, -1, p->get_item_position( it ),
                            "gaming" );
...
int iuse::oxytorch( player *p, item *it, bool, const tripoint & )
{
    ...
    p->assign_activity( activity_id( "ACT_OXYTORCH" ), duration, static_cast<int>( ter ),
...
int iuse::hacksaw( player *p, item *it, bool t, const tripoint &pos )
{
    ...
    p->assign_activity( activity_id( "ACT_HACKSAW" ), duration, static_cast<int>( ter ),
                        p->get_item_position( it ) );
    p->activity.placement = dirp;

...
class player : public Character
{
    public:
         ...
         */
        time_duration time_to_read( const item &book, const player &reader,
                                    const player *learner = nullptr ) const;
    ...
    public:
        ...
        void assign_activity( const activity_id &type, const time_duration &duration,

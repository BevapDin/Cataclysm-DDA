...
void safemode::show( const std::string &custom_name_in, bool is_safemode_in )
{
    ...
    catacurses::window w_help( ( FULL_SCREEN_HEIGHT / 2 ) - 2,
                                FULL_SCREEN_WIDTH * 3 / 4, 7 + offset_y + ( FULL_SCREEN_HEIGHT / 2 ) / 2, offset_x + 19 / 2 );
    catacurses::window w_border( FULL_SCREEN_HEIGHT, FULL_SCREEN_WIDTH,
                                  offset_y, offset_x );
    catacurses::window w_header( header_height, FULL_SCREEN_WIDTH - 2,
                                  1 + offset_y, 1 + offset_x );
    catacurses::window w( content_height, FULL_SCREEN_WIDTH - 2,
...
void safemode::test_pattern( const int tab_in, const int row_in )
{
    ...
    catacurses::window w_test_rule_border( content_height + 2, content_width,
                                            offset_y, offset_x );
    catacurses::window w_test_rule_content( content_height, content_width - 2,
            1 + offset_y, 1 + offset_x );

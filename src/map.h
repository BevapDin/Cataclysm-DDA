...
class map
{
    ...
    public:
         ...
         */
        void drawsq( WINDOW *w, player &u, const int x, const int y, const bool invert,
                     const bool show_items,
         ...
         */
        bool accessable_items( const int Fx, const int Fy, const int Tx, const int Ty,
         ...
         */
        bool accessable_furniture( const int Fx, const int Fy, const int Tx, const int Ty,
                                   const int range ) const;
        ...
        void set( const int x, const int y, const std::string new_terrain,
        ...
        std::string get_ter( const int x,
                             const int y ) const; // Terrain string id at coord (x, y); {x|y}=(0, SEE{X|Y}*3]
        ...
        bool has_flag_ter_and_furn( const std::string &flag, const int x,
                                    const int y ) const; // checks terrain and furniture
        ...
        bool has_flag_ter_or_furn( const ter_bitflags flag, const int x,
                                   const int y ) const; // checks terrain or furniture
        bool has_flag_ter_and_furn( const ter_bitflags flag, const int x,
                                    const int y ) const; // checks terrain and furniture
        ...
        //
        void translate( const std::string terfrom,
                        const std::string terto ); // Change all instances of $from->$to
        void translate_radius( const std::string terfrom, const std::string terto, const float radi,
                               const int uX, const int uY );
        void translate( const ter_id from, const ter_id to ); // Change all instances of $from->$to
        void translate_radius( const ter_id from, const ter_id to, const float radi, const int uX,
                               const int uY );
        ...
        void set_temperature( const int x, const int y,
        ...
        bool process_fields_in_submap( submap *const current_submap, const int submap_x,
                                       const int submap_y ); // See fields.cpp
        ...
        void put_items_from( items_location loc, const int num, const int x, const int y,
                             const int turn = 0,
    ...
    private:
        ...
        void process_active_items_in_vehicle( vehicle *cur_veh, submap *const current_submap,
                                              const int gridx, const int gridy );
        bool process_active_item( item *it, submap *const current_submap, const int gridx, const int gridy,

...
// Movement and LOS
 ...
 bool sees( tripoint F, tripoint T, int range, int &bresenham_slope ) const;
...
// vehicles
 ...
 point veh_part_coordinates( tripoint p );
...
// Terrain
 ...
 const ter_t & ter_at(const tripoint &p) const; // Terrain at coord (x, y); {x|y}=(0, SEE{X|Y}*3]
...
protected:
        ...
        void remove_rotten_items( Container &items, const tripoint &pnt );
        /**
...
private:
 ...
 bool outside_cache_dirty;
         ...
         */
        size_t get_nonant( point gp ) const;
        size_t get_nonant( tripoint gp ) const;
        /**

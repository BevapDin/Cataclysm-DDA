...
void options_manager::init()
{
    ...
    add( "AUTOSAVE", "general", translate_marker( "Periodically autosave" ),
    ...
    add( "STATIC_NPC", "world_default", translate_marker( "Static npcs" ),
        translate_marker( "If true, the game will spawn static NPC at the start of the game, requires world reset." ),
        false
        );
...
std::string options_manager::show(bool ingame, const bool world_options_only)
{
    ...
    catacurses::window w_options_border(FULL_SCREEN_HEIGHT, FULL_SCREEN_WIDTH, iOffsetY - iWorldOffset, iOffsetX);
    catacurses::window w_options_tooltip(iTooltipHeight, FULL_SCREEN_WIDTH - 2, 1 + iOffsetY, 1 + iOffsetX);
    catacurses::window w_options_header(1, FULL_SCREEN_WIDTH - 2, 1 + iTooltipHeight + iOffsetY, 1 + iOffsetX);
    catacurses::window w_options(iContentHeight, FULL_SCREEN_WIDTH - 2, iTooltipHeight + 2 + iOffsetY, 1 + iOffsetX);

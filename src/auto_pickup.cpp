...
void auto_pickup::show( const std::string &custom_name, bool is_autopickup )
{
    ...
    catacurses::window w_help( ( FULL_SCREEN_HEIGHT / 2 ) - 2, FULL_SCREEN_WIDTH * 3 / 4,
                                        7 + iOffsetY + (FULL_SCREEN_HEIGHT / 2) / 2, iOffsetX + 19 / 2);

    catacurses::window w_border( FULL_SCREEN_HEIGHT, FULL_SCREEN_WIDTH, iOffsetY, iOffsetX );
    catacurses::window w_header( iHeaderHeight, FULL_SCREEN_WIDTH - 2, 1 + iOffsetY,
                                          1 + iOffsetX);
    catacurses::window w( iContentHeight, FULL_SCREEN_WIDTH - 2, iHeaderHeight + 1 + iOffsetY,
                                   1 + iOffsetX);
...
void auto_pickup::test_pattern(const int iTab, const int iRow)
{
    ...
    catacurses::window w_test_rule_border( iContentHeight + 2, iContentWidth, iOffsetY, iOffsetX );
    catacurses::window w_test_rule_content( iContentHeight, iContentWidth - 2, 1 + iOffsetY, 1 + iOffsetX );

...
void player::sort_armor()
{
    ...
    */
    ...
    // Layout window
    catacurses::window w_sort_armor( win_h, win_w, win_y, win_x );
    draw_grid( w_sort_armor, left_w, middle_w );
    // Subwindows (between lines)
    catacurses::window w_sort_cat( 1, win_w - 4, win_y + 1, win_x + 2 );
    catacurses::window w_sort_left( cont_h, left_w,   win_y + 3, win_x + 1 );
    catacurses::window w_sort_middle( cont_h - num_bp - 1, middle_w, win_y + 3,
                                       win_x + left_w + 2 );
    catacurses::window w_sort_right( cont_h, right_w,  win_y + 3,
                                      win_x + left_w + middle_w + 3 );
    catacurses::window w_encumb( num_bp + 1, middle_w,

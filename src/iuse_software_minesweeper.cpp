...
int minesweeper_game::start_game()
{
    ...
    catacurses::window w_minesweeper_border( FULL_SCREEN_HEIGHT, FULL_SCREEN_WIDTH, iCenterY, iCenterX );
    catacurses::window w_minesweeper( FULL_SCREEN_HEIGHT - 2, FULL_SCREEN_WIDTH - 2, iCenterY + 1, iCenterX + 1 );

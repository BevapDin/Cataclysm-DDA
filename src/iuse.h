...
// FOOD AND DRUGS (ADMINISTRATION)
    ...
    int flu_vaccine         (player*, item*, bool, tripoint);
    int poison              (player*, item*, bool, tripoint);
    int fun_hallu           (player*, item*, bool, tripoint);
    int meditate            (player*, item*, bool, tripoint);
...
// TOOLS
    ...
    int elec_chainsaw_off   (player *, item *, bool, tripoint);
    int elec_chainsaw_on    (player *, item *, bool, tripoint);
    ...
    int holster_gun         (player*, item*, bool, tripoint);
    ...
    int remove_all_mods     (player*, item*, bool, tripoint);
    ...
    int weather_tool        (player*, item*, bool, tripoint);
...
// MACGUFFINS
    ...
    int remoteveh(player*, item*, bool, tripoint);

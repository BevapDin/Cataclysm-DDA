...
// TOOLS
    int firestarter         (player*, item*, bool, const tripoint&);
    int resolve_firestarter_use(player *p, item *, const tripoint&);
    ...
    int shishkebab_off      (player*, item*, bool, const tripoint&);
    int shishkebab_on       (player*, item*, bool, const tripoint&);
    int firemachete_off     (player*, item*, bool, const tripoint&);
    int firemachete_on      (player*, item*, bool, const tripoint&);
    int broadfire_off       (player*, item*, bool, const tripoint&);
    int broadfire_on        (player*, item*, bool, const tripoint&);
    int firekatana_off      (player*, item*, bool, const tripoint&);
    int firekatana_on       (player*, item*, bool, const tripoint&);
    int zweifire_off        (player*, item*, bool, const tripoint&);
    int zweifire_on         (player*, item*, bool, const tripoint&);
    ...
    int knife               (player*, item*, bool, const tripoint&);

...
class generic_factory
{
    ...
    public:
         ...
         * @param id_member_name The name of the JSON member that holds the id of the object.
         */
        ...
        T &load( JsonObject &jo ) {
            ...
            if( mode == "override" ) {
                ...
                if( !exists ) {
                    jo.throw_error( "missing definition of " + type_name + " \"" + id.str() + "\" to be modified", id_member_name );
                }
                iter->second.load( jo );
                return iter->second;

    ...
    generic_vehicle_part_range<vehicle_part_with_feature_range<feature_type>>
{
    ...
    public:
        vehicle_part_with_feature_range( ::vehicle &v, feature_type f, const bool u, const bool e ) : generic_vehicle_part_range<vehicle_part_with_feature_range<feature_type>>( v ), feature_( std::move( f ) ), unbroken_( u ), enabled_( e ) { }

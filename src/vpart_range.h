...
class vehicle_part_with_condition_range : public
    generic_vehicle_part_range<vehicle_part_with_condition_range>
{
    private:
    ...
    public:
        vehicle_part_with_condition_range( ::vehicle &v,
                                           decltype( condition_ ) c ) : generic_vehicle_part_range( v ), condition_( std::move( c ) ) { }

...
{
    npc *comp = companion_choose_return( p.name + "_scavenging_patrol", calendar::turn-6000 );
    if (comp == NULL){
        return false;
    }
...
{
    npc *comp = companion_choose_return( p.name + "_scavenging_raid", calendar::turn-6000 );
    if (comp == NULL){
        return false;
    }
...
bool talk_function::labor_return( npc &p )
{
    ...
    npc *comp = companion_choose_return( p.name + "_labor", calendar::turn-600 );
    if (comp == NULL){
        return false;
    }
...
{
    npc *comp = companion_choose_return( p.name + "_carpenter", calendar::turn-600 );
    if (comp == NULL){
        return false;
    }
...
{
    //minimum working time is 1 hour
    npc *comp = companion_choose_return( p.name + "_forage", calendar::turn-2400 );
    if (comp == NULL){
        return false;
    }

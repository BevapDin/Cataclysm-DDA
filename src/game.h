...
class game
{
    ...
    private:
        ...
        void pick_recipes(crafting_inventory_t &crafting_inv, std::vector<const recipe *> &current,
                          std::vector<bool> &available, craft_cat tab, craft_subcat subtab,
                          std::string filter);// crafting.cpp
        void batch_recipes(crafting_inventory_t &crafting_inv, std::vector<const recipe *> &current,

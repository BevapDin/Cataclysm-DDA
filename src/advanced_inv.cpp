...
bool advanced_inventory::move_all_items( bool nested_call )
{
    ...
    if( spane.get_area() == AIM_INVENTORY || spane.get_area() == AIM_WORN ) {
        ...
        if( dpane.get_area() == AIM_INVENTORY || dpane.get_area() == AIM_WORN ) {
            ...
            g->u.assign_activity( activity_id( "ACT_MOVE_ITEMS" ), time_duration::from_moves( calendar::INDEFINITELY_LONG ) );
...
void advanced_inventory::do_return_entry()
{
    ...
    save_settings( true );
    g->u.assign_activity( activity_id( "ACT_ADV_INVENTORY" ), time_duration::from_moves( calendar::INDEFINITELY_LONG ) );

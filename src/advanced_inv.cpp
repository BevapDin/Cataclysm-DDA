...
void advanced_inventory::init()
{
    ...
    head = catacurses::window( head_height, w_width - minimap_width, headstart, colstart );
    mm_border = catacurses::window( minimap_height + 2, minimap_width + 2, headstart,
                        colstart + ( w_width - ( minimap_width + 2 ) ) );
    minimap = catacurses::window( minimap_height, minimap_width, headstart + 1,
                      colstart + ( w_width - ( minimap_width + 1 ) ) );
    left_window = catacurses::window( w_height, w_width / 2, headstart + head_height, colstart );
    right_window = catacurses::window( w_height, w_width / 2, headstart + head_height,
                           colstart + w_width / 2 );

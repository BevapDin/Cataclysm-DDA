                                        ...
                                        int veh_root_part )
{
    ...
    const bool has_purify = ( veh->avail_part_with_feature( veh_root_part, "WATER_PURIFIER", true ) >= 0 );
    ...
    const int washing_machine_part = veh->avail_part_with_feature( veh_root_part, "WASHING_MACHINE", true );

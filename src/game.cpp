...
bool game::handle_liquid(item &liquid, bool from_ground, bool infinite, item *source, vehicle *vsource)
{
    ...
    if (vsource == NULL && liquid.type->id == "gasoline" && vehicle_near() && query_yn(_("Refill vehicle?"))) {

...
struct requirements {
    ...
    bool can_make_with_inventory(const crafting_inventory_t& crafting_inv) const;

    int print_components(WINDOW *w, int ypos, int xpos, int width, nc_color col, const crafting_inventory_t &crafting_inv) const;
    int print_tools(WINDOW *w, int ypos, int xpos, int width, nc_color col, const crafting_inventory_t &crafting_inv) const;
    int print_time(WINDOW *w, int ypos, int xpos, int width, nc_color col) const;

private:
    bool check_enough_materials(const crafting_inventory_t& crafting_inv) const;
    bool check_enough_materials(const item_comp& comp, const crafting_inventory_t& crafting_inv) const;
    ...
    template<typename T>
    static bool has_comps(const crafting_inventory_t &crafting_inv, const std::vector< std::vector<T> > &vec);
    template<typename T>
    static int print_list(WINDOW *w, int ypos, int xpos, int width, nc_color col, const crafting_inventory_t &crafting_inv, const std::vector< std::vector<T> > &objs);
    template<typename T>

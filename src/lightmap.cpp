...
void map::build_seen_cache()
{
    ...
    seen_cache(g->u.posx, g->u.posy, 0) = true;
    ...
    if (vehicle *veh = veh_at(offsetX, offsetY)) {
        ...
        for( auto &mirror : mirrors ) {
            ...
            castLight<0, 1, 1, 0>( 1, 0, 1.0f, 0.0f, 0, 0, mirrorX, mirrorY, offsetDistance );
            castLight<1, 0, 0, 1>( 1, 0, 1.0f, 0.0f, 0, 0, mirrorX, mirrorY, offsetDistance );

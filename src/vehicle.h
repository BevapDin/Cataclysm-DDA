...
class vehicle
{
    ...
    public:
        ...
        cata::optional<vpart_reference> install_part( int dx, int dy, const vpart_id &id, bool force = false );

        // Install a copy of the given part, skips possibility check
        cata::optional<vpart_reference> install_part( int dx, int dy, const vehicle_part &part );

        /** install item specified item to vehicle as a vehicle part */
        cata::optional<vpart_reference> install_part( int dx, int dy, const vpart_id &id, item &&obj, bool force = false );

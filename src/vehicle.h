...
class vehicle
{
    ...
    public:
        ...
        cata::optional<vpart_reference> avail_part_with_feature( const pocata::optional<vpart_reference> &pt, const std::string &f ) const;
        ...
        cata::optional<vpart_reference> avail_part_with_feature_include_broken( const pocata::optional<vpart_reference> &pt, const std::string &f ) const;

        ...
        const inventory &crafting_inv, int batch, std::string hilite ) const
{
    ...
    out_buffer.push_back( "<color_" + string_from_color( col ) + ">" + _( "Components required:" ) + "</color>" );
        ...
        const inventory &crafting_inv, int batch ) const
{
    ...
    output_buffer.push_back( "<color_" + string_from_color( col ) + ">" + _( "Tools required:" ) + "</color>" );
    if( tools.empty() && qualities.empty() ) {
        output_buffer.push_back( "<color_" + string_from_color( col ) + ">" + "> " + "</color>" + "<color_" + string_from_color( c_green ) + ">" + _( "NONE" ) + "</color>" );
